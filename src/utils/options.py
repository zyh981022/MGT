...
parser.add_argument('--bert_hidden_dim', type=int, default=128, help='Size of hidden vectors (d_model)')
...
parser.add_argument('--MLP_DS',type=str,default='DS', help='Method for MLP Layer')
parser.add_argument('--add_pos_before',default='N', choices=['Y', 'N'],help="add positional embedding before")
parser.add_argument('--add_pos_after',default='N', choices=['Y', 'N'],help="add positional embedding after")
