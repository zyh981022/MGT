...
class BERTAllTrainer(object):
    def __init__(self, args, model, train_loader, val_loader, test_loader, ckpt_root, user2seq):
        ...
        self.metric_ks = args.metric_ks # default [5, 10, 20]
        self.best_metric = args.best_metric # default = 'NDCG@10'
    ...
    def train(self):
        ...
        for epoch in range(self.num_epochs):
            ...
            print(f'Train time epoch:{t_end_training-t_start_training}')
    ...
    def validate_test(self, epoch, accum_iter, mode="val", target=None):
        ...
        torch.cuda.empty_cache()
        t_end_validate = time.time()
        print(f'Valid time epoch:{t_end_validate - t_start_validate}')
            ...
            optimizer_grouped_parameters = [
                {
                    ...
                    "weight_decay": args.weight_decay, # 除了bias norm user_emb 其他都要用weight_decay
                },
    ...
    def _create_loggers(self):
        ...
        model_checkpoint = root.joinpath('models') # 存储模型参数的路径
